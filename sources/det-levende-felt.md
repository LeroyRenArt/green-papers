...
I september 2026 befinder Spiralweb sig mellem konstitutionelt grundlagsarbejde og en bredere offentlig fase. Foreningen eksisterer. Hjemmesiderne og det versionerede videnshabitat er offentligt tilgængelige, men den bredere offentlige åbning er endnu ikke gennemført. De nære relationer til mennesker og steder er virkelige, og [den første fælles indsamling er åben](https://spiralweb.earth/support/). Grundlag for aftaler, lokale spørgsmål, veje for støtte til mennesker og steder, roller og mulige observationsformer er ved at tage form i forskellige tempi.
...
1. Læg mærke til, hvad der faktisk sker.
2. Spørg, hvem og hvad der allerede bærer feltet.
3. Hold observation, fortolkning og hypotese adskilt.
4. Mød en anden viden eller læsning.
5. Vælg én lille bevægelse, som stedet og de ansvarlige mennesker kan bære.
6. Navngiv beslutning, mandat, ressourcer, usikkerhed og forventet retur.
7. Se, hvad handlingen — eller pausen — gør.
8. Lad konsekvensen ændre næste skridt og, hvor det er relevant, den offentlige arkitektur.
...
- [*Atlas of a Living Architecture*](https://papers.spiralweb.earth/papers/atlas-of-a-living-architecture) giver en guidet vej gennem Spiralwebs begreber, rum og arkitektur.
- [*The Spiral of Hypotheses*](https://papers.spiralweb.earth/papers/the-spiral-of-hypotheses) gør de nuværende korrigerbare wagers og deres revisionsbetingelser synlige.
...
- [Spiralweb.earth](https://spiralweb.earth/) viser aktuelle relationer, felter og ansvar. [Spiralweb Papers](https://papers.spiralweb.earth/) bærer den åbne, versionerede undersøgelse og dens offentlige hukommelse.
