...
- **allokeret:** pengene eller arealmålet findes i en overordnet ramme;
- **aftalt:** konkrete parter, arealer og forpligtelser er bundet;
- **frigivet:** jord, penge eller arbejdskapacitet er faktisk gjort tilgængelig;
- **bogført:** handlingen er gennemført og registreret.
...
- arealfonden finansierer omlægning og erstatningsjord;
- landbrugsordninger betaler for bestemte handlinger eller arealer;
- kommunen planlægger, behandler sager og deltager i den lokale trepart;
- forsyningen håndterer vand inden for sine lovbundne opgaver;
- plan- og byggesystemet regulerer beboelse;
- forskere og naturorganisationer producerer viden;
- arbejdsmarkedsinstitutionerne behandler beskæftigelse og forsørgelse.
...
- \(R_A\) alle indtægter og betalinger fra drift og økologisk arbejde;
- \(K_A\) alle drifts-, kapital- og risikoomkostninger bortset fra indkomsten til de personer, der undersøges;
- \(Y_A\) det faktiske indkomstgrundlag.

Det mulige B-gab skrives derefter:

\[
B_{gap}=\max(0,(P\times L)-Y_A)
\]

Her er \(P\) det nødvendige antal personer eller fuldtidsækvivalenter, og \(L\) den valgte lokale indkomstkomparator. Udtrykket \(\max(0,...)\) betyder blot, at gabet sættes til nul, hvis indkomstgrundlaget allerede er tilstrækkeligt.
...
- Hvor ofte kræver arealet faktisk fysisk tilstedeværelse?
- Hvor nær skal den ansvarlige være?
- Kan eksisterende boliger, vagtordninger eller transport løse opgaven?
- Hvilke bolig- og brugsformer er lovlige på det konkrete areal?
- Hvem får værdistigningen, hvis en særlig adgang til beboelse skaber privat kapitalgevinst?
...
- Flyttes den tidligere produktion til et andet areal?
- Ændres importen af foder eller fødevarer mærkbart?
- Hvilke materialer og energistrømme kræver den nye praksis?
- Hvem bærer gæld eller tab ved ændret jordværdi?
- Kan næste generation overtage brugen uden at kapitalisere formålet væk?
