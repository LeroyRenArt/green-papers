...
const mdPath = "sources/rule-of-life.da.md";
const templatePath = "papers/report-06-regenerative-reciprocity.html";
const outPath = "papers/rule-of-life-da.html";
...
const series = getLine("Serie") || "Serie IV — Field Papers";
const paperType = getLine("Papertype") || "Konstitutionelt feltpaper · Økonomisk feltpaper · Note om fælledernes styring";
const version = getLine("Version") || "v1.0 · Release candidate";
const date = getLine("Dato") || "Maj 2026";
const author = getLine("Forfatter") || "Lars A. Engberg, ph.d. — uafhængig videnspraktiker og protokoludvikler";
...
const bodyStart = md.search(/\*\*Indexnote\*\*/);
if (bodyStart < 0) {
  console.error("Could not find **Indexnote** marker.");
  process.exit(1);
}
...
<title>${escapeHtml(title)} — Penguin Economics og fælledernes ledger · Green Papers</title>
<meta name="description" content="Et Green Paper af Lars A. Engberg om Penguin Economics, regenerativ reciprocitet, PG Ledger, Rule of Life, 13×13-borgervidenskab, AI-stewardship og grundlaget for en Planetary Stewardship Economy." />
<meta name="author" content="Lars A. Engberg" />
<link rel="canonical" href="https://papers.spiralweb.earth/papers/rule-of-life-da" />
<meta property="og:title" content="Rule of Life — Penguin Economics og fælledernes ledger" />
<meta property="og:description" content="Et konstitutionelt og økonomisk feltpaper om stewardship, reciprocitet, commons-governance, AI, borgervidenskab og livsunderstøttende værdi." />
...
<div class="header">
  ${logo}
  <div class="meta"><span class="series">Serie IV · Field Papers</span></div>
...
<div class="footer">
<p><strong>Serie IV · Field Papers</strong></p>
<p>Green Papers / Spiralweb · Roskilde, Danmark</p>
<p>${escapeHtml(version)} · ${escapeHtml(date)} · Creative Commons Attribution 4.0 International (CC BY 4.0)</p>
<p><a href="../">Green Papers-indeks</a> · <a href="https://spiralweb.earth/">spiralweb.earth</a></p>
</div>
